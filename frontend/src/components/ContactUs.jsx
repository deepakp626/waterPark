            ...
            <section className=' space-y-8 md:grid grid-cols-2'>
                ...
                <form className=' space-y-8 my-12'>
                    ...
                    <div className='divtag'>
                        <label className='labeltag' htmlFor="name"> <span className='spantag'>1.</span> Whats your Name?</label>
                        <input className='inputField' type="text" name='name'
                            placeholder='Type your full Name' />
                    </div>
                    <div className='divtag'>
                        <label className='labeltag' htmlFor="name"> <span className='spantag'>2.</span> Whats your Email Address?</label>
                        <input className='inputField' type="text" name='name'
                            placeholder='example@email.com' />
                    </div>
                    <div className='divtag'>
                        <label className='labeltag' htmlFor="name"> <span className='spantag'>3.</span> Whats your Phone Number?</label>
                        <input className='inputField' type="text" name='name'
                            placeholder='+91' />
                    </div>
                    <div className='divtag'>
                        <label className='labeltag' htmlFor="name"> <span className='spantag'>4.</span> What's Your Message</label>
                        <input className='inputField' type="text" name='name'
                ...
                <section className="m-12 sm:m-8">
                    <div className="grid grid-cols-2 md:grid-cols-1  gap-y-4 gap-x-0 justify-center">
                        <div>
                            <h3 className="font-medium text-xs sm:text-lg">Call Us</h3>
                            <p className="font-normal text-[9px] sm:text-base">Mon-Fri from 8:00 A.M.. to 5:00 P.M. </p>
                            <a className="text-primary" href="tel:09279294900">09279294900</a>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="font-normal text-[9px] sm:text-base"> Motipur, Ratanpura, Bihar 843111</p>
                        </div>
                    </div>

                    <div className="my-4 self-start">
                        <iframe className="max-w-[28rem] h-56  sm:min-w-[30rem] md:min-w-[22rem]"
